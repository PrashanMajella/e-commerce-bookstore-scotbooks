<section>
    <div class="relative px-6 lg:px-8 bg-white">
        <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
            <div>
                <div>
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Anim aute id magna aliqua ad ad
                    ...
                    <div class="mt-8 flex gap-x-4 sm:justify-center">
                        <a href="{{ route('product.index') }}"
                            class="inline-block rounded-lg bg-pink-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-pink-600 hover:bg-pink-700 hover:ring-pink-700">
                            Get started
                            <span class="text-pink-200" aria-hidden="true">&rarr;</span>
                        </a>
