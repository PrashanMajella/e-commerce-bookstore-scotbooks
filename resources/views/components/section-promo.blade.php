                ...
                <div>
                    <div class="mt-10">
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-6 lg:space-x-8">
                                    ...
                                    <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                        ...
                                        <div class="h-64 w-44 overflow-hidden rounded-lg">
                                            <img src="{{ asset('storage/images/app/product-5.jpg') }}"
                                                alt="" class="h-full w-full object-cover object-center">
                                        </div>
                                    </div>
                                    <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                        <div class="h-64 w-44 overflow-hidden rounded-lg">
                                            <img src="{{ asset('storage/images/app/product-6.jpg') }}"
                                                alt="" class="h-full w-full object-cover object-center">
                                        </div>
                                        <div class="h-64 w-44 overflow-hidden rounded-lg">
                                            <img src="{{ asset('storage/images/app/product-7.jpg') }}"
                                                alt="" class="h-full w-full object-cover object-center">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <a href="{{ route('product.index') }}"
                            class="inline-block rounded-md border border-transparent bg-pink-600 py-3 px-8 text-center font-medium text-white hover:bg-pink-700"
                        >
                            Shop Collection
                        </a>
                    </div>
