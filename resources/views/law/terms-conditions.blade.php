    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="m-10">
                    <div class="">
                        <h1 class="text-4xl font-bold">Terms & Conditions for Scotbooks</h1>
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                            <strong>Last updated: January 08, 2023</strong>
                            <p>Please read these terms and conditions carefully before using our service.</p>
                            <p>
                                This Terms & Conditions describes Our policies and procedures on the collection, use and disclosure of Your
                            ...
                            <p>
                                ...
                                and use of information in accordance with this Terms & Conditions. This Terms & Conditions have been created with the
                                help of the
                    ...
                    <div class="">
                        <h1 class="text-4xl font-bold">Interpretation and Definitions</h1>
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                        ...
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                            <h2 class="text-2xl font-bold">Definitions</h2>
                            <p>For the purposes of this Terms & Conditions:</p>
                            <ul class="flex flex-col items-start gap-5 mx-10 my-2 list-disc">
                                <li>
                                ...
                                <li>
                                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                                        or &quot;Our&quot; in this Agreement) refers to Scotbooks Corp., Ormiston Grows, Pencaitland Railway
                                        Walk, East Lothian, Alba, Scotland, EH35 5AH, United Kingdom..</p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <p><strong>Website</strong> refers to Scotbooks, accessible from <a href="http://www.scotbooks.uk"
                                            rel="external nofollow noopener" target="_blank">http://www.scotbooks.uk</a></p>
                                </li>
                                <li>
                    ...
                    <div class="">
                        <h1 class="text-4xl font-bold">Collecting and Using Your Personal Data</h1>
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                            <h2 class="text-2xl font-bold">Types of Data Collected</h2>
                            <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                            ...
                            <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                                <h3 class="text-xl font-bold">Tracking Technologies and Cookies</h3>
                                <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                                    ...
                                    <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal
                                        ...
                                        browser. Learn more about cookies on the <a
                                            ...
                                            target="_blank">Free Terms & Conditions website</a> article.</p>
                                    ...
                                    <p>For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy
                                        or the Cookies section of our Terms & Conditions.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                            <h2 class="text-2xl font-bold">Use of Your Personal Data</h2>
                            <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                                <div class="">
                                ...
                                <div class="">
                                    ...
                                    <ul class="flex flex-col items-start gap-5 mx-10 my-2 list-disc">
                                        ...
                                        <li><strong>With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will
                                            require those affiliates to honor this Terms & Conditions. Affiliates include Our parent company and any other
                        ...
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                            <h2 class="text-2xl font-bold">Retention of Your Personal Data</h2>
                            <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                            ...
                            <h2 class="text-2xl font-bold">Transfer of Your Personal Data</h2>
                            <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                                ...
                                <p>Your consent to this Terms & Conditions followed by Your submission of such information represents Your agreement to
                                    that transfer.</p>
                                <p>The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in
                                    accordance with this Terms & Conditions and no transfer of Your Personal Data will take place to an organization or
                                    a country unless there are adequate controls in place including the security of Your data and other personal
                                    information.</p>
                            </div>

                            <h2 class="text-2xl font-bold">Delete Your Personal Data</h2>
                            <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                        ...
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                            <h2 class="text-2xl font-bold">Disclosure of Your Personal Data</h2>
                            <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                                <h3 class="text-xl font-bold">Business Transactions</h3>
                                <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will
                                    provide notice before Your Personal Data is transferred and becomes subject to a different Terms & Conditions.
                                </p>
                            </div>
                            <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                                <h3 class="text-xl font-bold">Law enforcement</h3>
                            ...
                            <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                                <h3 class="text-xl font-bold">Other legal requirements</h3>
                        ...
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                            <h2 class="text-2xl font-bold">Security of Your Personal Data</h2>
                            <div class="flex flex-col items-start justify-center text-justify gap-5 my-2">
                    ...
                    <div class="">
                        <h1 class="text-4xl font-bold">Children's Privacy</h1>
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                    ...
                    <div class="">
                        <h1 class="text-4xl font-bold">Links to Other Websites</h1>
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                            <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link,
                                You will be directed to that third party's site. We strongly advise You to review the Terms & Conditions of every
                                site You visit.
                            </p>
                    ...
                    <div class="">
                        <h1 class="text-4xl font-bold">Changes to this Terms & Conditions</h1>
                        <div class="flex flex-col items-start justify-center text-justify gap-5 my-5">
                            <p>We may update Our Terms & Conditions from time to time. We will notify You of any
                                changes by posting the new Terms & Conditions on this page.
                            </p>
                            <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective
                                and update the &quot;Last updated&quot; date at the top of this Terms & Conditions.</p>
                            <p>You are advised to review this Terms & Conditions periodically for any changes. Changes to this Terms & Conditions are
                    ...
                    <div class="">
                        ...
                        <div class="flex flex-col items-start justify-center text-start gap-5 my-5">
                            <p>If you have any questions about this Terms & Conditions, You can contact us:</p>
                            <ul class="flex flex-col items-start gap-5 mx-10 my-2 list-disc">
                                <li>By visiting this page on our website:
                                    <a href="http://www.scotbooks.uk/contact"
                                        rel="external nofollow noopener" target="_blank" class="text-pink-600 hover:text-pink-500">http://www.scotbooks.uk/contact
                                    </a>
                                </li>
                            </ul>
                        </div>
