<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 md:-my-px md:ml-10 md:flex">
                    ...
                    <x-nav-link :href="route('cart.index')" :active="request()->routeIs('cart.index')" class="relative">
                        {{ __('Cart') }}
                        <x-base-counter-circle x-on:cart-change.window="count = $event.detail.count">
                            {{ \App\Helpers\Cart::getCartItemsCount() }}
                        </x-base-counter-circle>
                    </x-nav-link>

                    <x-nav-link :href="route('watchlist.index')" :active="request()->routeIs('watchlist.index')" class="relative">
                        {{ __('Watchlist') }}
                        <x-base-counter-circle x-on:watchlist-change.window="count = $event.detail.count">
                            {{ \App\Helpers\Watchlist::getWatchlistItemsCount() }}
                        </x-base-counter-circle>
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('cart.index')" :active="request()->routeIs('cart.index')" class="relative">
                {{ __('Cart') }}
                <x-base-counter-circle x-on:cart-change.window="count = $event.detail.count">
                    {{ \App\Helpers\Cart::getCartItemsCount() }}
                </x-base-counter-circle>
            ...
            <x-responsive-nav-link :href="route('watchlist.index')" :active="request()->routeIs('watchlist.index')" class="relative">
                {{ __('Watchlist') }}
                <x-base-counter-circle x-on:watchlist-change.window="count = $event.detail.count">
                    {{ \App\Helpers\Watchlist::getWatchlistItemsCount() }}
                </x-base-counter-circle>
